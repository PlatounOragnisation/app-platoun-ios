...
class Tab1ViewController: UIViewController, ReloadedViewController {
    ...
    @IBOutlet weak var backPlatounSwipeButton: UIButton!
    ...
    override func viewDidLoad() {
        ...
        codeButton.setTitle("Réductions débloquées", for: .normal)
        ...
        backPlatounSwipeButton.setTitle("Retour à Platoun Swipe", for: .normal)
    ...
    @IBAction func backPlatounSwipeAction(_ sender: Any) {
